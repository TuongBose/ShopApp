...
(
    MALOAISANPHAM INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
    TENLOAISANPHAM VARCHAR(255) NOT NULL
);

CREATE TABLE THUONGHIEU
(
	MATHUONGHIEU INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE DONHANG (
    ...
    TRANGTHAI TINYINT NOT NULL CHECK(TRANGTHAI IN (0, 1, 2, 3)),
    NGAYDATHANG DATE,
    TONGTIEN INT,
